        ...
        <div className="space-y-8 overflow-y-auto no-scrollbar flex-1">
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Track Report (All authenticated users) */}
              <li className={navItemClass('/trackreport')}>
                <NavLink to="/trackreport" className={navLinkClass('/trackreport')}>
                  <div className="flex items-center">
                    <svg className={navIconClass('/trackreport')} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      <path d="M15.7 3.3c-.4-.4-1-.4-1.4 0L7 10.6 2.7 6.3c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l5 5c.2.2.4.3.7.3.3 0 .5-.1.7-.3l8-8c.4-.4.4-1 0-1.4z" />
                    </svg>
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Track Report</span>
                  </div>
                </NavLink>
              </li>

              {/* Public Asset (All authenticated users) */}
              <li className={navItemClass('/public/asset')}>
                <NavLink to="/public/asset/123" className={navLinkClass('/public/asset')}>
                  <div className="flex items-center">
                    <svg className={navIconClass('/public/asset')} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      <path d="M12 1a1 1 0 1 0-2 0v2a3 3 0 0 0 3 3h2a1 1 0 1 0 0-2h-2a1 1 0 0 1-1-1V1ZM1 10a1 1 0 1 0 0 2h2a1 1 0 0 1 1 1v2a1 1 0 1 0 2 0v-2a3 3 0 0 0-3-3H1ZM5 0a1 1 0 0 1 1 1v2a3 3 0 0 1-3 3H1a1 1 0 0 1 0-2h2a1 1 0 0 0 1-1V1a1 1 0 0 1 1-1ZM12 13a1 1 0 0 1 1-1h2a1 1 0 1 0 0-2h-2a3 3 0 0 0-3 3v2a1 1 0 1 0 2 0v-2Z" />
                    </svg>
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Public Asset</span>
                  </div>
                </NavLink>
              </li>
